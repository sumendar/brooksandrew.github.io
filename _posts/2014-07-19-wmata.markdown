...
Roughly 80% of the time.  Play with the app below to see the range of actual wait times you can expect for any Nextbus prediction.

<iframe style="border: 0px;" src="/simpleblog/assets/html/d3nextbus.html" width="1000" height="600"></iframe>

Early days are defined such that there is a 10% chance the bus will arrive before the predicted wait time.  
Late days are defined such that there is a 10% chance the bus will arrive after the predicted wait time.  
