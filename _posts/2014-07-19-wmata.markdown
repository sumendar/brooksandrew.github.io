...
81% of the time.  Interact with the app below to see the range of actual wait times you can expect for any Nextbus prediction.
...
* 70% of the time buses are no more than 4 minutes late (and no more than 30 seconds early) for predictions of 15 minutes or more.  
* 70% of the time buses are no more than 1:52 minutes late (and no more than 19 seconds early) for predictions of 5 minutes.  
...
* 90% of the time buses are no more than 7 minutes late (and no more than 1:30 minutes early) for predictions of 15 minutes or more.  
* 90% of the time buses are no more than 2:43 minutes late (and no more than 53 seconds early) for predictions of 5 minutes.  
...
* [pulling from the WMATA API]("/simpleblog/nextbus1_api")
* [data grunt work]("/simpleblog/nextbus2_wrangle")
* [analysis and pictures]("/simpleblog/nextbus3_analyze")
* [fancy pictures]("/simpleblog/nextbus4")
